...
import { UserStats, TeacherProfile, UserRole, AppState } from '../types';
import { Home, User, Mail, UserCheck, Shield, Edit3, Save, Loader2, AlertCircle, CheckCircle2, Award, X, HelpCircle } from 'lucide-react';
import { updateUserProfileName, fetchTeacherInfo } from '../services/statsService';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center p-4 sm:p-8 font-sans relative">
      <div className="w-full max-w-2xl animate-fade-in-up">
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <h1 className="text-3xl font-black text-slate-800">الملف الشخصي</h1>
          <div className="w-14 h-14"></div> {/* Spacer */}
        </div>

        {/* Profile Card */}
        <div className="bg-white rounded-[3rem] shadow-xl border border-white p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center mb-10">
                <div className={`w-32 h-32 rounded-full flex items-center justify-center text-5xl font-black text-white shadow-2xl mb-4 border-8 border-white ${isTeacher ? 'bg-purple-600' : 'bg-indigo-600'}`}>
                    {initials}
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-400 mr-2 uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="space-y-2">
                    ...
                    <div className="px-6 py-4 rounded-2xl bg-slate-50 border-2 border-transparent text-slate-500 font-medium flex items-center gap-3">
                        <span dir="ltr">{playerData.email}</span>
                ...
                {!isTeacher && (
                    <div className="space-y-2 animate-fade-in">
                        ...
                        <div className="px-6 py-4 rounded-2xl bg-indigo-50 border-2 border-indigo-100 text-indigo-700 font-black flex items-center justify-between">
                            ...
                            <div className="bg-white p-1.5 rounded-lg text-indigo-400">
                                <Award size={18} />
                            </div>
                        </div>
                    </div>
